...
- Modern web browser or Node.js 20+ depending on the project folder
...
Keep browser-only tools local-first, validate user input, and avoid sending file contents to remote services.
